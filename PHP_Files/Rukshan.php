    ...
    <body>
        ...
        <div>
            ...
            <div id="table">
                <div id="page-wrap">
                    <!-- Setting the image -->
                    <img src="../IMAGES/rukshan1.jpg" alt="Photo of Rukshan" id="pic" height="280" width="260" border="5"/>

                    <div id="contact-info" class="vcard">

                        <h1 class="fn">Rukshan Hassim</h1>

                        <p>
                            Mobile: <span class="tel">077-2459943</span><br />
                            <!-- setting up email to be send to the clicked link -->
                            Email: <a class="email" href="mailto:rukihass13@gmail.com">rukihass13@gmail.com</a>
                        </p>
                    </div>
